...
namespace PlayerManager3 // >>> Change to PlayerManager2 for exercise 4 <<< //
{
    ...
    public class Program
    {
        ...
        private void ShowMenu()
        {
            ...
            // COMPLETE ME PLEASE! //
            // /////////////////// //
            Console.WriteLine("Insert number to select option");
            Console.WriteLine("1 - Insert Player");
            Console.WriteLine("2 - List Players");
            Console.WriteLine("3 - List Players with a Score greater than");
        ...
        private void InsertPlayer()
        {
            ...
            int player_score = int.Parse(Console.ReadLine());
            playerList.Add(new Player(player_name,player_score));
        }
        ...
        private void ListPlayersWithScoreGreaterThan()
        {
            ...
            // COMPLETE ME PLEASE! //
            // /////////////////// //
            Console.WriteLine("Insert the minimum score: ");
            int input_minscore = int.Parse(Console.ReadLine());
